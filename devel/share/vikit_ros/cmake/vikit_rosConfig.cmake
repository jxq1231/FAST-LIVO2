...
if("TRUE" STREQUAL "TRUE")
  set(vikit_ros_SOURCE_PREFIX /root/FAST-LIVO2_ws/src/rpg_vikit/vikit_ros)
  set(vikit_ros_DEVEL_PREFIX /root/FAST-LIVO2_ws/devel)
  ...
  set(vikit_ros_INSTALL_PREFIX /root/FAST-LIVO2_ws/install)
...
if(NOT "/root/FAST-LIVO2_ws/src/rpg_vikit/vikit_ros/include;/usr/include/eigen3;/usr/include/opencv4;/root/Sophus " STREQUAL " ")
  set(vikit_ros_INCLUDE_DIRS "")
  set(_include_dirs "/root/FAST-LIVO2_ws/src/rpg_vikit/vikit_ros/include;/usr/include/eigen3;/usr/include/opencv4;/root/Sophus")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vikit_ros_NUM_DUMMY_TARGETS)
      set(vikit_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vikit_ros::wrapped-linker-option${vikit_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vikit_ros_NUM_DUMMY_TARGETS "${vikit_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vikit_ros::wrapped-linker-option${vikit_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vikit_ros_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND vikit_ros_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vikit_ros_dep}_FOUND)
      find_package(${vikit_ros_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vikit_ros_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(vikit_ros_EXPORTED_TARGETS ${${vikit_ros_dep}_EXPORTED_TARGETS})
endforeach()
